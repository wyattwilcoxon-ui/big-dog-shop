            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="font-body text-pebble text-sm leading-relaxed">
                  Megan's inspiration came after adopting Bosa, a 115-pound German Shepherd with equally "large-scale" needs. For years, Megan had used two standard pet waste bags for her other German Shepherd, Carmen, but Bosa's size quickly made that routine unworkable. Even the largest commercial bags couldn't keep up resulting in waste, inefficiency, and frequent messes. After realizing she was going through up to eight small bags a day, she thought, there has to be a better way.
                </p>
              </div>
            </motion.div>
