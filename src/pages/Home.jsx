...
const MARQUEE_ITEMS_1 = [
  'BIG DOG ENERGY', 'BUILT IN OHIO', 'BIG DOGS DESERVE BETTER', 'WE GIVE A $H!T',
  'BECAUSE BIG DOGS HAVE BIG NEEDS', 'BELLEFONTAINE OH', 'NAMED AFTER BOSA',
];

const MARQUEE_ITEMS_2 = [
  'BIG DOG LIFE', 'FOR LARGE & GIANT BREEDS', '#BOSIEBLAST', 'SINCE 2024',
  'PACK APPROVED', 'ZERO APOLOGIES', 'BIG DOGS RUN THE SHOW',
];
