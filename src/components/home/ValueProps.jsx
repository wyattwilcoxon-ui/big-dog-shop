...
const PROPS = [
  ...
  },
  {
    ...
    description: '13" × 15" — 44% bigger than regular bags. Your 90-lb Lab doesn\'t make chihuahua poops.',
    bg: 'bg-secondary/10',
  ...
  },
  {
    ...
    description: 'Made with plant-based, biodegradable film. Good for your dog. Good for the planet.',
    bg: 'bg-sky/20',
    border: 'border-sky',
    rotate: -1,
  },
