  ...
  return (
    <section className="relative min-h-[90vh] sm:min-h-screen overflow-hidden bg-midnight">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0" style={{ background: 'linear-gradient(to bottom, rgba(15,29,60,0.85) 0%, rgba(15,29,60,0.6) 40%, rgba(15,29,60,0.4) 60%, rgba(15,29,60,0.2) 75%, transparent 100%)' }} />
      </div>
