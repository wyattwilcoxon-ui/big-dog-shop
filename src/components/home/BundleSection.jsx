          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="p-8 sm:p-12 flex flex-col justify-center">
              ...
              <p className="font-body text-pebble leading-relaxed mb-6">
                Everything you need for the big dog life - in one pack. 1,080 The Bosie Bag® 12" x 13.5" oversized waste bags, a Clip & Go Dispenser Pouch with one starter roll already inside, and three Big Dog Life™ The Big Ones tennis balls.
              </p>

              <ul className="space-y-3 mb-8">
                {[
                  '1,080 The Bosie Bag® waste bags (9 rolls x 120 bags)',
